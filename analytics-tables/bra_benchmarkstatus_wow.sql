...
, pw_bad_count
, pw_unknown_count
, pw_above_1_mbps_per_student_count
, pw_avg_mbps_per_student
, (cw_good_count - pw_good_count) wow_change_good
, (cw_moderate_count - pw_moderate_count) wow_change_moderate
, (cw_bad_count - pw_bad_count) wow_change_bad
, (CASE WHEN (pw_good_count IS NULL) THEN null ELSE ((cw_good_count - pw_good_count) / CAST(NULLIF(pw_good_count, 0) AS decimal(10, 2))) END) wow_change_percentage_good
, (CASE WHEN (pw_moderate_count IS NULL) THEN null ELSE ((cw_moderate_count - pw_moderate_count) / CAST(NULLIF(pw_moderate_count, 0) AS decimal(10, 2))) END) wow_change_percentage_moderate
, (CASE WHEN (pw_bad_count IS NULL) THEN null ELSE ((cw_bad_count - pw_bad_count) / CAST(NULLIF(pw_bad_count, 0) AS decimal(10, 2))) END) wow_change_percentage_bad
, (CASE WHEN (pw_unknown_count IS NULL) THEN null ELSE ((cw_unknown_count - pw_unknown_count) / CAST(NULLIF(pw_unknown_count, 0) AS decimal(10, 2))) END) wow_change_percentage_unknown
, (CASE WHEN (pw_above_1_mbps_per_student_count IS NULL) THEN null ELSE ((cw_above_1_mbps_per_student_count - pw_above_1_mbps_per_student_count) / CAST(NULLIF(pw_above_1_mbps_per_student_count, 0) AS decimal(10, 2))) END) wow_above_1_mbps_per_student
, (CASE WHEN (pw_avg_mbps_per_student IS NULL) THEN null ELSE ((cw_avg_mbps_per_student - pw_avg_mbps_per_student) / CAST(NULLIF(pw_avg_mbps_per_student, 0) AS decimal(10, 2))) END) wow_avg_mbps_per_student
FROM
  previous_week
