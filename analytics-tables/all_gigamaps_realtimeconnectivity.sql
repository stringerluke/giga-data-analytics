...
SELECT 
      COALESCE(realtimeconn.realtime_connectivity_date, ms.schools_count_date, cs.connectivity_date) AS date, 
       COALESCE(ms.country, realtimeconn.country, cs.country) AS country,
      COALESCE(schools_added, 0) as schools_added,
      COALESCE(cs.connected_schools, 0) as connected_schools, 
      COALESCE(count_realtime_mapped_schools, 0) as count_realtime_mapped_schools
