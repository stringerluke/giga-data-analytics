...
SELECT
  DISTINCT
    p.local_created_date,
    p.local_date_hour,
    
    -- Hour offset for timezone alignment
    date_add('hour', -1, p.local_date_hour) AS local_date_minus_1hr,
    p.local_hour,
    ...
    p.local_hour BETWEEN 8 AND 20 AS is_school_hours,
